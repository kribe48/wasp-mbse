 ...
 * </p>
 * <ul>
 *   <li>{@link turtlebotmission.impl.MissionImpl#getTask <em>Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MissionImpl extends NamedElementImpl implements Mission {
	...
	protected EClass eStaticClass() {
		return TurtlebotmissionPackage.Literals.MISSION;
	}
	...
	public EList<Task> getTask() {
		if (task == null) {
			task = new EObjectContainmentEList<Task>(Task.class, this, TurtlebotmissionPackage.MISSION__TASK);
		}
		return task;
	}
