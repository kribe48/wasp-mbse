...
/**
 * This is the item provider adapter for a {@link turtlebotmission.Area} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Area_xmax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Area_xmax_feature", "_UI_Area_type"),
				 TurtlebotmissionPackage.Literals.AREA__XMAX,
				 true,
				 false,
				 false,
	...
	protected void addYmaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Area_ymax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Area_ymax_feature", "_UI_Area_type"),
				 TurtlebotmissionPackage.Literals.AREA__YMAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Area_type") + " " + area.getXmax();
	}
	...
	public ResourceLocator getResourceLocator() {
		return TurtlebotmissionEditPlugin.INSTANCE;
	}
