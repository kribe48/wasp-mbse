...
/**
 * This is the item provider adapter for a {@link turtlebotmission.Mission} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionItemProvider extends NamedElementItemProvider {
	/**
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Mission.class)) {
			case TurtlebotmissionPackage.MISSION__TASK:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TurtlebotmissionPackage.Literals.MISSION__TASK,
				 TurtlebotmissionFactory.eINSTANCE.createLineTask()));

		newChildDescriptors.add
			(createChildParameter
				(TurtlebotmissionPackage.Literals.MISSION__TASK,
				 TurtlebotmissionFactory.eINSTANCE.createShortestPathTask()));

		newChildDescriptors.add
			(createChildParameter
				(TurtlebotmissionPackage.Literals.MISSION__TASK,
				 TurtlebotmissionFactory.eINSTANCE.createReturnToStartTask()));
	}
