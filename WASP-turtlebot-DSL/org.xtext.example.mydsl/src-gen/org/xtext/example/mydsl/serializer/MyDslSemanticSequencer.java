...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Area(ISerializationContext context, Area semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurtlebotmissionPackage.Literals.AREA__XMAX) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurtlebotmissionPackage.Literals.AREA__XMAX));
			if (transientValues.isValueTransient(semanticObject, TurtlebotmissionPackage.Literals.AREA__YMAX) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurtlebotmissionPackage.Literals.AREA__YMAX));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAreaAccess().getXmaxEIntParserRuleCall_3_0(), semanticObject.getXmax());
		feeder.accept(grammarAccess.getAreaAccess().getYmaxEIntParserRuleCall_6_0(), semanticObject.getYmax());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (waypointtypes+=[WaypointType|EString] waypointtypes+=[WaypointType|EString]* name=EString coord_x=EInt coord_y=EInt)
	 */
	...
	protected void sequence_WaypointType(ISerializationContext context, WaypointType semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWaypointTypeAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.finish();
	}
